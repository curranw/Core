...
class NNDimReduce(object):
    ...
    def build_dim_reduction(self, dim_max):
        ...
        for i in range(0,dim_max):
            ...
            layer = Dense(int(dim_max/(2*2)), activation='sigmoid', input_shape=(dim_max/2,))
            layer2 = Dense(encoding_dim, activation='sigmoid', input_shape=(int(dim_max/(2*2)),))
            ...
            export_model(model_e, 'encoder.model.batch_2048.evenmoredata.'+str(i+1))
