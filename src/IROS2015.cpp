...
void IROS2015::setup_experiments()
{
    ...
    normal_learning_swimmers("Swimmers_Small");
//    for(unsigned int i = 0; i < 10; i++)
//    {
        //pca_learning_swimmers("converged_state_data_swimmers_good_5.csv", -1, "save_file", 1, true);
//    }
...
void IROS2015::pca_learning_swimmers(string pca_file, int amount, string save_file, int dim, bool iterative)
{
    ...
    learning_args->weight_file = "converged_state_rewards_swimmers_good.csv";
