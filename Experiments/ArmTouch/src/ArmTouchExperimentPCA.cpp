...
ArmTouchExperimentPCA::ArmTouchExperimentPCA(ArmTouch *domain, QTilesReuse *learning_algorithm, ArmTouchExperimentPCAArgs* exp_args)
...
void ArmTouchExperimentPCA::init()
{
    IExperiment::init();
...
void ArmTouchExperimentPCA::step()
{
    cur_step++;
...
void ArmTouchExperimentPCA::end_epoch()
{
...
void ArmTouchExperimentPCA::output_results()
{
...
ArmTouchExperimentPCA::~ArmTouchExperimentPCA()
{
    delete m_domain;
