...
TurtleStairsExperiment::TurtleStairsExperiment(TurtleStairs* domain, QTiles* learning_algorithm, TurtleStairsExperimentArgs* exp_args)
...
void TurtleStairsExperiment::init()
{
    IExperiment::init();
    //m_learning_algorithm->read("TurtleStairsQTable");
...
void TurtleStairsExperiment::step()
{
    cur_step++;
...
void TurtleStairsExperiment::end_epoch()
{
...
void TurtleStairsExperiment::output_results()
{
      utils::to_csv<double>(&m_rewards, m_exp_args->save_file);
      m_learning_algorithm->output("TurtleStairsQTable");
...
void TurtleStairsExperiment::load_updates(string update_file)
{
    QTiles* temp_learning_alg = (QTiles*)m_learning_algorithm;
...
TurtleStairsExperiment::~TurtleStairsExperiment()
{
